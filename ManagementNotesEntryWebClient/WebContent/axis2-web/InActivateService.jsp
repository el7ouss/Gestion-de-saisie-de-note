...
<tr>
  <td colspan="2" >
     <p>Only the services that are active are listed below. Niveau that although you can activate a service from this page, once system is restarted the service will be active again</p>
  </td>
  </tr>
  <tr>
<%
