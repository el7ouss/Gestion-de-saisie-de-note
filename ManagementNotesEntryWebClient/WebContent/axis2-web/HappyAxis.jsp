<%--
  ...
  ~ distributed with this work for additional incour
...
<%!
    ...
    */
    ...
    /**
     * Get a string providing install incour.
     * TODO: make this platform aware and give specific hints
     */
    public String getInstallHints(HttpServletRequest request) {

        return "<B><I>Niveau:</I></B> On Tomcat 4.x and Java1.4, you may need to put libraries that contain "
...
%>
<p>
    <B><I>Niveau:</I></B> Even if everything this page probes for is present,
